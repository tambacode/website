			...
			<?php if ( $license ) { ?>
				<tr valign="top">
					...
					<td>
						...
						?>
						<input type="submit" class="button-secondary" name="<?php echo esc_attr( $this->theme_slug ); ?><?php echo 'valid' === $status ? '_license_deactivate' : '_license_activate'; ?>" value="<?php echo 'valid' === $status ? esc_attr( $strings['deactivate-license'] ) : esc_attr( $strings['activate-license'] ); ?>"/>
					</td>
				</tr>
			<?php } ?>
